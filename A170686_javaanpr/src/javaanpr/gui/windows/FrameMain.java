    ...
    public class RecognizeThread extends Thread {
        ...
        public void run() {
            ...
            try {
        		...
        		BufferedImage oriImg = core.runCore(recordUrl);
        		graphics2D.drawImage(oriImg, 0, 0, width, height, null);
        		this.parentFrame.panelCarContent = resizeImg;
        		
//				this.parentFrame.panelCarContent = core.runCore(recordUrl);
    ...
    public class LoadImageThread extends Thread {
        ...
        public void run() {
        	try {
        		...
        		graphics2D.drawImage(oriImg, 0, 0, width, height, null);
        		this.parentFrame.panelCarContent = resizeImg;
//				this.parentFrame.panelCarContent = ImageIO.read(new File(this.url));
				parentFrame.panelCar.paint(this.parentFrame.panelCar.getGraphics());
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
    ...
    private void initComponents() {
        ...
        bottomLine.setText(" [ <GUI from 2006 Ondrej Martinsky> Modified by (2020-2021) Edmund Ngu ]. \t "
        		+ "\t [ Algorithm Copyright (c) 2020-2021 Edmund Ngu ]");
